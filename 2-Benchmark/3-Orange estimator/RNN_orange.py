...
#National data
Data = pd.read_csv('Outputs/dataset_national.csv')
...
concatenated_pred.to_csv('/Users/Yannig/Documents/These_Nathan/Mobility_data_review/Results/prediction_RNN_orange_residuals.txt', index=True, header=True)
