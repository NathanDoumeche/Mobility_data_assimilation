...
gbm_forecast = predict_gb_discriminate(fit, Data_nat, Data_nat$tod)

RMSE(Data_nat$Load[test_norm], gbm_forecast[test_norm])
MAPE(Data_nat$Load[test_norm], gbm_forecast[test_norm])
